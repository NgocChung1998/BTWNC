<%@ Page Title="SHOPPET.VN" Language="C#" MasterPageFile="~/MasterPage/client.Master" AutoEventWireup="true" CodeBehind="ThongTinSanPham.aspx.cs" Inherits="MasterPageDemo.ThongTinSanPham" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id ="ThongTinChiTiet">
        ...
        <div id="NoiDung">
            <asp:Label ID="lblTenMyPham" runat="server" Text="" CssClass="lblTenMyPham"></asp:Label><br/>
            <asp:Label ID="lblGia" runat="server" Text="" CssClass="lblGia"></asp:Label><br/>
            <asp:Label ID="lblLoaiMyPham" runat="server" Text="" CssClass="lblLoaiMyPham"></asp:Label><br/>
            <asp:Label ID="lblHangMyPham" runat="server" Text="" CssClass="lblHangMyPham"></asp:Label><br/>
